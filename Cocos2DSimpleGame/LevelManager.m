...
- (id)init {
    if ((self = [super init])) {
        ...
        Level * level2 = [[[Level alloc] initWithLevelNum:2 secsPerSpawn:1 backgroundColor:ccc4(255, 255, 255, 255)] autorelease];
        ...
        Level * level5 = [[[Level alloc] initWithLevelNum:5 secsPerSpawn:.3 backgroundColor:ccc4(255, 255, 255, 255)] autorelease];
        _levels = [@[level1, level2,level3,level4,level5] retain];
    }
    return self;
}
